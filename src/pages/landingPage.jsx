  ...
  return (
    <>
      <section className="max-w-screen-2xl mx-auto">
        <div className="mt-[80px] w-[80%] m-auto flex justify-between items-center gap-8">
          <div className="">
          <h1 className="text-[35px] md:text-[70px] font-extrabold leading-20 tracking-wide">
            Discover Your Dream Job!
          </h1>
          <p className="text-gray-400 text-[20px] mt-4 px-5">
            Lorem ipsum dolor sit amet. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptatibus repellat tempore suscipit!
          </p>
        ...
        <div>
          <Carousel
            className="w-[80%] z-10 m-auto mt-[70px] py-10"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8  mt-[70px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: <Code2 />, title: "Technology", jobs: "1,543 jobs" },
              { icon: <Building2 />, title: "Business", jobs: "892 jobs" },
              { icon: <Palette />, title: "Design", jobs: "766 jobs" },
              { icon: <BookOpen />, title: "Education", jobs: "577 jobs" },
            ].map((category, index) => (
              <div
                key={index}
                className={`${
                ...
                } p-6 rounded-xl shadow-lg hover:shadow-md transition-shadow`}
              >
                <div className="text-indigo-600 mb-4">{category.icon}</div>
                <h3 className="text-xl font-semibold mb-2">{category.title}</h3>
                <p className="text-gray-400">{category.jobs}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* CTA Section */}
        <div className="bg-indigo-600 py-16 mt-[140px]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex justify-center space-x-4">
              <button className="bg-white text-indigo-600 px-8 py-3 rounded-lg hover:bg-gray-600">
                Post Your Resume
              </button>
              <button className="border-2 border-white text-white px-8 py-3 rounded-lg hover:bg-indigo-700">
                Browse Jobs
              </button>
            </div>
          </div>
        ...
        {/* Featured Companies */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-[140px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <p className="text-gray-400 mb-2">{company.location}</p>
                <p className="text-indigo-600">{company.openings}</p>
              </div>
            ))}
          </div>
        </div>
